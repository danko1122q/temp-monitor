...
void print_help(const char *prog_name) {
    ...
    printf(COLOR_BRIGHT_BLACK "For more information, visit: https://github.com/yourusername/temp-monitor\n" COLOR_RESET);
    printf("\n");
}
...
int initialize_sensors(void) {
    ...
    if (sensor_count == 0) {
        printf("\n");
        printf(COLOR_RED COLOR_BOLD "✗ ERROR: No temperature sensors detected!\n" COLOR_RESET);
        printf("\n");
